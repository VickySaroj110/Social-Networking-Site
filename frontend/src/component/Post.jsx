...
function Post({ post, onUpdate, isSavedProp }) {
    ...
    return (
        <div className='w-[90%] min-h-[450px] pb-[20px] max-w-[500px] flex flex-col gap-4 bg-[#1a1a1a] items-center shadow-lg shadow-[#00000030] rounded-2xl overflow-y-scroll border border-gray-700'>
            ...
            {showShareModal && (
                <div className='fixed inset-0 z-[300] bg-black/60 flex items-center justify-center p-4 rounded-2xl'>
                    <div className='bg-[#0e1718] rounded-3xl p-6 max-w-[400px] w-full'>
                        <h2 className='text-white text-xl font-bold mb-4'>Share Post</h2>
                        ...
                        <div className='flex gap-3'>
                            <button
                                ...
                                className='flex-1 bg-blue-500 text-white py-2 rounded-full font-semibold disabled:opacity-50'
                                onClick={handleSharePost}
                            >
                                {shareLoading ? 'Sending...' : 'Send'}
                            </button>
                            <button
                                className='flex-1 border-2 border-gray-500 text-gray-400 py-2 rounded-full font-semibold'
                                onClick={() => {
                                    setShowShareModal(false)
                                    setSelectedShareUser(null)
                                }}
            ...
            <div className='w-full flex justify-between items-center px-4 py-3'>
                ...
                >
                    <div className='w-12 h-12 md:w-14 md:h-14 border-2 border-gray-600 rounded-full cursor-pointer overflow-hidden'>
            ...
            {/* ACTION BUTTONS */}
            <div className='w-full h-[60px] flex justify-between items-center px-[20px] mt-[10px] text-white'>
            ...
            {/* CAPTION */}
            {post.caption && (
                <div className='w-full px-[20px] gap-[10px] flex justify-start items-center text-white'>
            ...
            {showComment &&
                <div className='w-full flex flex-col gap-[30px] pb-[20px]'>
                    <div className='w-full h-[80px] flex items-center justify-between px-[20px]'>
                        ...
                        <input
                            type="text"
                            className='px-[10px] border-b-2 border-b-gray-600 bg-transparent w-[90%] outline-none h-[40px] text-white placeholder-gray-500'
                        ...
                        <button onClick={handleComment}>
                            <FaRegPaperPlane className="cursor-pointer w-[20px] h-[20px] text-white" />
                        </button>
                    </div>
                    ...
                    <div className='w-full max-h-[300px] overflow-auto'>
                        {(!post.comments || post.comments.length === 0) ? (
                            ...
                            post.comments.map((com) => (
                                <div key={com._id} className='w-full px-[20px] py-[20px] border-b-2 border-b-gray-700'>
                                    <div className='flex gap-3'>
                                        <div
                                            className='w-[40px] h-[40px] border-2 border-gray-600 rounded-full overflow-hidden cursor-pointer'
                                        ...
                                        <div className='flex flex-col flex-1 min-w-0'>
                                            <span
                                                className='text-white font-medium cursor-pointer truncate'
                                                onClick={() => navigate(`/profile/${com.author.userName}`)}
                                            >
